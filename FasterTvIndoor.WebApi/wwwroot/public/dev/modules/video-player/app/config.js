(function () {
    ...
    angular.module('fasterVideoPlayer').constant('SETTINGS', {
        'VERSION':'0.0.1',
        'CURR_ENV':'dev',
        'AUTH_TOKEN':'faster-token',
        'AUTH_USER':'faster-user',
        'SERVICE_URL':'/'
        //'SERVICE_URL': 'http://redefaster.azurewebsites.net/',
    });

    angular.module('fasterVideoPlayer').run(function ($rootScope, $location, editableOptions, SETTINGS) {        
