(function () {
    ...
    angular.module('fasterAdministration').controller('ListEquipmentInactiveCtrl', ListEquipmentInactiveCtrl);

    ListEquipmentInactiveCtrl.$inject = ['EquipmentFactory', 'RedirectUserService'];

    function ListEquipmentInactiveCtrl(EquipmentFactory, RedirectUserService) {
        ...
        vm.filter = { skip: 1, word: null, status: 4 };
