(function () {
    ...
    angular.module('fasterAdministration').controller('ListEquipmentAvailableCtrl', ListEquipmentAvailableCtrl);

    ListEquipmentAvailableCtrl.$inject = ['EquipmentFactory', 'RedirectUserService'];

    function ListEquipmentAvailableCtrl(EquipmentFactory, RedirectUserService) {
        ...
        vm.filter = { skip: 1, word: null, status: 1 };
