(function () {
    ...
    angular.module('fasterAdministration').controller('ListEquipmentUnavailableCtrl', ListEquipmentUnavailableCtrl);

    ListEquipmentUnavailableCtrl.$inject = ['EquipmentFactory', 'RedirectUserService'];

    function ListEquipmentUnavailableCtrl(EquipmentFactory, RedirectUserService) {
        ...
        vm.filter = { skip: 1, word: null, status: 2 };
