(function () {
    ...
    angular.module('fasterBackOffice').controller('ListEmployeeInactiveCtrl', ListEmployeeInactiveCtrl);

    ListEmployeeInactiveCtrl.$inject = ['EmployeeFactory', 'RedirectUserService'];

    function ListEmployeeInactiveCtrl(EmployeeFactory, RedirectUserService) {
        ...
        function removeEmployee(employee) {
            ...
            function success(response) {
                ...
                if (vm.page > 1 && vm.employees.length == 0)
