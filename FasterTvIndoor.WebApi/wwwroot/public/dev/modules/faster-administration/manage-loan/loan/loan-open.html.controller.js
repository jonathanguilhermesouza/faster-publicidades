(function () {
    ...
    angular.module('fasterAdministration').controller('ListLoanOpenCtrl', ListLoanOpenCtrl);

    ListLoanOpenCtrl.$inject = ['ControlLoanFactory', 'RedirectUserService'];

    function ListLoanOpenCtrl(ControlLoanFactory, RedirectUserService) {
