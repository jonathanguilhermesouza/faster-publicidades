(function () {
    ...
    angular.module('fasterAdministration').controller('ListLoanClosedCtrl', ListLoanClosedCtrl);

    ListLoanClosedCtrl.$inject = ['ControlLoanFactory', 'RedirectUserService'];

    function ListLoanClosedCtrl(ControlLoanFactory, RedirectUserService) {
