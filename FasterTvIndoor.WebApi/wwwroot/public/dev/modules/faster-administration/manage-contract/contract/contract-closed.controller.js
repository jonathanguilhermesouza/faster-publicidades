(function () {
    ...
    angular.module('fasterAdministration').controller('ContractClosedCtrl', ContractClosedCtrl);

    ContractClosedCtrl.$inject = ['ContractFactory','RedirectUserService'];

    function ContractClosedCtrl(ContractFactory, RedirectUserService) {
        ...
        vm.filter = { skip: 1, status: 2, word: null };
