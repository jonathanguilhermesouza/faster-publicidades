(function () {
    ...
    angular.module('fasterAdministration').controller('ListVideoActiveCtrl', ListVideoActiveCtrl);

    ListVideoActiveCtrl.$inject = ['$location', '$rootScope', 'SETTINGS', 'VideoFactory', 'RedirectUserService'];

    function ListVideoActiveCtrl($location, $rootScope, SETTINGS, VideoFactory, RedirectUserService) {
